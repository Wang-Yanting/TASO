...
DEEPSEEK_CHAT_PROMPT = {
    "description": "Template used by DeepSeek models",
    "prompt": "<|begin▁of▁sentence|>You are a helpful assistant\n\nUser: {instruction}\n\nAssistant:"
}

DEEPSEEK_R1_PROMPT = {
    "description": "Template used by DeepSeek models",
    "prompt": "<|begin▁of▁sentence|>You are a helpful assistant<|User|>{instruction}<|Assistant|><think>\n"
...
def get_template(model_name_or_path=None, chat_template=None, fschat_template=None, system_message=None, return_fschat_conv=False, **kwargs):
    ...
    elif chat_template == "llama-3.1" or chat_template == "llama-3":
        TEMPLATE = LLAMA31_CHAT_PROMPT
    ...
    elif chat_template == "deepseek_chat":
        TEMPLATE = DEEPSEEK_CHAT_PROMPT
...
def get_adv_init(args,targetLM):
    ...
    if "phi3" in args.target_model:
        adv_init = '!' * args.n_tokens_adv
    elif "mistral" in args.target_model or "mixtral" in args.target_model:
        adv_init = '!!!!' * args.n_tokens_adv
    elif "llama2" in args.target_model or "vicuna" in args.target_model or "r2d2" in args.target_model:
        adv_init = "!!" * args.n_tokens_adv
